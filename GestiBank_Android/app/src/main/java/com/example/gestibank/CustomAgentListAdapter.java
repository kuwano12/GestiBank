...
public class CustomAgentListAdapter extends BaseAdapter {
    private List<User> listUser;
    private LayoutInflater layoutInflater;
    private Context context;

    public CustomAgentListAdapter(Context context, List<User>listUser) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(u != null){
            Log.e("ERROR --------->", holder.agentName.getText().toString());
